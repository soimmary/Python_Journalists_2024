...
| :----: | -|-|-|
| 10 января ✅| Тема 1. Переменные и арифметические действия| Вводный семинар||
| 10 января ✅| Тема 1. Переменные и арифметические действия| Jupyter Notebook, базовые операции в Python||
| 24 января ✅| Тема 2. Логический тип данных и условный оператор| Булевы значения|Мини-тест|
| 24 января ✅| Тема 2. Логический тип данных и условный оператор| if-elif-else||
| 7 февраля ✅| Тема 3. Цикл while| While c условием|Мини-тест|
| 7 февраля ✅| Тема 3. Цикл while| While True||
| 21 февраля ✅| Тема 4. Введение в структурированные типы данных и цикл for| Списки, кортежи|Мини-тест|
| 21 февраля ✅| Тема 4. Введение в структурированные типы данных и цикл for| Цикл for|Самостоятельная работа (в конце на 20 минут)|
| 28 февраля ✅| Тема 5. Методы| Цикл for + методы|Самостоятельная работа (в начале на 20 минут)|
| 28 февраля ✅| Тема 5. Методы| Методы строк, списков||
| 6 марта ✅| Тема 6. Неупорядоченные типы данных| Множества|Мини-тест |
| 6 марта ✅| Тема 6. Неупорядоченные типы данных| Словари||
| 13 марта ✅| Подготовка к кр| ||
| 13 марта ✅| Контрольная (темы 1-6)| ||
| 15 марта| Тема 7. Вложенные структуры данных. Сортировки| Списки словарей, словари словарей||
| 15 марта| Тема 8. Функции| Функции||
| 20 марта| Тема 9. Текстовые файлы и таблицы| Файлы|Мини-тест|
| 20 марта| Тема 9. Текстовые файлы и таблицы| Файлы|Самостоятельная работа (в начале на 20 минут)|
| 22 марта| Защита проекта| ||
| 22 марта| Защита проекта| ||
...
По содержанию заданий аналогичен независимому экзамену, т.к. дисциплина-пререквизит готовит к сдаче НЭ. Проводится в сессию в оффлайн-формате.
